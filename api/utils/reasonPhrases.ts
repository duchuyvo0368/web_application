/**
 * Danh sách các cụm từ lý do HTTP tương ứng với các mã trạng thái.
 * Nguồn: RFC chính thức hoặc tài liệu mô tả chuẩn HTTP.
 */
class ReasonPhrases {
    ACCEPTED = 'Accepted';
...
const reasonPhrases = new ReasonPhrases();
